<?php
    ...
    $hashtag = getHashtagByName($dbh, $hashtag_name);
    $ticket = new Ticket($ticket_id, NULL, NULL, $status_id, $depart_id, NULL, $agent_id, $priority, $hashtag['hashtag_id'], NULL, $updated);
