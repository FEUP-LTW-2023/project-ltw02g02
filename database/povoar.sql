...
INSERT INTO User (user_id, user_name, username, email, user_password, user_type, depart_id) VALUES (2, 'Pedro', 'pedro', 'pedro@gmail.com', '$2y$10$Lu9Y9/oXS6qjQYCHgNkBnedMk4VOE1GR41JUgVy2rNXO3WZgMqeUG', 'Agent', 1); 
...
INSERT INTO Ticket (ticket_id, ticket_subject, ticket_description, ticket_priority, status_id, hashtag_id, user_id) VALUES (1, 'Product Repair', 'My device does not turn on', 'Low', 1, 1, 1);
